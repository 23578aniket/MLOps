...
encode_dict = {
    "fuel_type": {'Diesel': 1, 'Petrol': 2, 'CNG': 3, 'LPG': 4, 'Electrical': 5},
...
fuel_type = col1.selectbox("Select the fuel type",
                           ['Diesel', 'Petrol', 'CNG', 'LPG', 'Electrical'])
...
#series of columns within with my model accept input
#[2012.0,120000,Petrol,Manual,19.7,796.0,46.3,5.0]
#encoded accepted format
